...
function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-black/30 backdrop-blur-md" data-testid="header">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-[18px] flex items-center justify-between gap-3">
        <a href="#inicio" className="flex items-center gap-[10px] hover:opacity-80 transition-opacity translate-y-[2px]" data-testid="logo-brand">
          ...
          />
          <span className="text-[0.94rem]" style={{ fontFamily: "'DM Sans', 'Inter', sans-serif", fontWeight: 300, color: '#FFFFFF', opacity: 1, WebkitFontSmoothing: "antialiased" }}><span style={{ letterSpacing: '1px' }}>AM</span>{' '}<span style={{ letterSpacing: '0.12em' }}>Web Design</span></span>
        </a>
  ...
  return (
    <section id="inicio" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20" data-testid="section-hero">
      ...
      >
        ...
        >
          <span className="font-medium tracking-[0.04em] text-[0.92em] bg-gradient-to-r from-[#5a8abf] via-[#7ba8d4] to-[#4a7aaf] bg-clip-text text-transparent opacity-[0.75]">Tu web</span> <span className="font-semibold tracking-[0em]" style={{ color: '#E6EDF5' }}>lista para vender</span>
          <br />
          <span className="font-light tracking-[0em] leading-[1.5] text-[0.88em]" style={{ color: '#C8D3E0' }}>y posicionar</span>
        </motion.h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 items-end">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <Card 
                  className={`group p-8 min-h-[280px] bg-black/30 backdrop-blur-[4px] border shadow-[inset_0_1px_0_0_rgba(255,255,255,0.03),0_4px_24px_rgba(0,0,0,0.12)] cursor-pointer hover:-translate-y-1.5 hover:scale-[1.01] hover:border-primary/50 hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05),0_8px_32px_rgba(0,0,0,0.18),0_0_20px_rgba(59,130,246,0.06)] transition-all duration-200 ease-in-out relative overflow-hidden ${isOpen ? 'border-primary/40 bg-black/40 animate-[glowPulse_3s_ease-in-out_infinite]' : ''} ${isDimmed ? 'border-white/[0.04]' : 'border-white/[0.06]'}`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-5 items-end">
            {benefits.map((benefit, index) => (
              <motion.div
                key={benefit.title}
                className="flex gap-4 p-5 rounded-xl bg-black/25 backdrop-blur-[4px] border border-white/[0.06] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.03),0_4px_24px_rgba(0,0,0,0.1)] hover:border-primary/25 hover:translate-y-[-2px] hover:bg-black/35 hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05),0_8px_32px_rgba(0,0,0,0.15),0_0_16px_rgba(59,130,246,0.05)] transition-all duration-500 ease-out w-full cursor-default"
    ...
    <section id="contacto" className="py-20 md:py-32 relative bg-black/70 backdrop-blur-sm" data-testid="section-contacto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-start max-w-5xl mx-auto">
          ...
          <motion.div
            className="bg-black/30 backdrop-blur-[4px] border border-white/[0.06] rounded-2xl p-8 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.03),0_4px_24px_rgba(0,0,0,0.12)]"
...
export default function Home() {
  return (
    <div className="min-h-screen overflow-x-hidden relative">
      <div 
        className="fixed inset-0 bg-cover bg-[center_60%] bg-no-repeat z-0"
