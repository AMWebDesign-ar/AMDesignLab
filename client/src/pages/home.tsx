...
function HeroSection() {
  return (
    <section id="inicio" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20" data-testid="section-hero">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-[hsl(220,12%,10%)]/80 via-[hsl(218,10%,14%)]/50 to-[hsl(220,8%,12%)]" />
      <div className="absolute inset-0 bg-gradient-to-r from-[hsl(220,10%,11%)]/70 via-transparent to-[hsl(220,10%,11%)]/70" />
      <div className="absolute inset-0 bg-gradient-to-t from-transparent via-[hsl(217,40%,18%)]/10 to-[hsl(217,40%,22%)]/8" />
      ...
      >
        ...
        <motion.h1 
          className="text-5xl md:text-7xl lg:text-8xl text-foreground mb-6 leading-[1.1] tracking-[-0.03em] drop-shadow-lg [text-shadow:0_0_30px_rgba(59,130,246,0.15)] max-w-4xl mx-auto"
          variants={fadeInUp}
