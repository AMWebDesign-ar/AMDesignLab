        ...
        {mobileMenuOpen && (
          ...
          >
            <nav className="flex flex-col px-6 py-4 gap-4">
              ...
              <a
                href="#contacto"
                className="inline-flex items-center justify-center px-7 py-2.5 text-xs font-semibold text-white rounded-full border border-[rgba(59,130,246,0.45)] bg-[rgba(59,130,246,0.08)] backdrop-blur-[6px] shadow-[0_0_16px_rgba(59,130,246,0.15)] animate-[glowPulse_3s_ease-in-out_infinite] hover:-translate-y-0.5 mt-2 transition-all duration-300 ease-in-out"
                onClick={handleNavClick}
    ...
    <section id="inicio" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20" data-testid="section-hero">
      ...
      >
        ...
        >
          ...
          <span className="text-[1.05rem] text-foreground/90 relative z-10">✦ Creamos webs estratégicas que convierten visitas en clientes</span>
        </motion.div>
        <motion.h1 
        ...
        >
          Diseño, estrategia y posicionamiento para negocios y marcas que buscan resultados reales
        </motion.p>
