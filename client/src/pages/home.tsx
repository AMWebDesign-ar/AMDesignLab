  ...
  return (
    <section id="inicio" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20" data-testid="section-hero">
      ...
      >
        ...
        >
          <span className="font-extrabold tracking-[-0.02em]" style={{ fontFamily: "'Outfit', sans-serif" }}>Potenciamos</span>
          <br />
        ...
        <motion.div 
          ...
          variants={fadeInUp}
        >
          <Button asChild size="sm" className="text-xs px-4 justify-center text-center" data-testid="button-hero-whatsapp">
